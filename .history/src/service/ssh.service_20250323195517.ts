...
import { Client as SSH2Client, ShellStream } from 'ssh2'; // Renamed import to avoid confusion
...
class SSHConnection {
  private conn: SSH2Client; // Use the renamed type
  ...
  constructor() {
    this.conn = new SSH2Client(); // Use renamed Client
